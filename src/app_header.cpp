 ...
 * All rights reserved
 *
 * Places the app_header_t at the base of the flash slot for a Vigil application.
 ...
 *
 * This file ships in the shared VigilOta library; the consuming firmware links
 ...
 *
 * Compiled only in a `*_slotA` build (which defines BV_OTA_SLOT_BUILD and uses
